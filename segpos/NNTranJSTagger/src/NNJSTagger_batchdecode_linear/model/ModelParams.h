...
class ModelParams {
  ...
  public:
    bool initial(HyperParams& opts) {
		...
		score.initial(opts.action_num, opts.state_hidden_dim, false);
		//DEV->random_uniform(score.W.val, score.W.val.shape(), -0.01, 0.01);
		//score.W.val.random(0.01);
        return true;
    }
